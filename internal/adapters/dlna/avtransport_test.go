...
func TestAVT_StubActions_Return501(t *testing.T) {
	...
	// handlers). Pause moved out in P3.1. The remaining three — Seek,
	// Next, Previous — still 501. Seek will flip in P3.2; Next/Previous
	// stay stubs because v1 has no queue model.
